...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Nói cho anh biết một bí mật';
document.querySelector('.Description .modal-body').innerHTML = 'Tim đập loạn như vậy là do ... Em thích anh lắm á!  <i class="fas fa-heart"></i> ';
